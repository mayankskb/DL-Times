...
#########################################################################
#
#  Return a dataframe with the results for Google and S&P 500.
#
#########################################################################
...
#########################################################################
#
#  Return a datframe with the results for Google and S&P 500
...
def read_goog_sp500_logistic_data():
	...
	# Resultant data with the values of S&P500 and intercept values of all 1s
